const translations = {
    ...
    ru: {
      ...
      about_me: "Обо мне",
      about_me_text: "Я студент бакалавриата \"Прикладная Математика и Информатика\" факультета компьютерных наук ВШЭ. Интересуюсь всем, что может быть описано математикой. Стажировался в Хуавее. Я не хотел польностью переносить информацию из резюме сюда, так как этот сайт может открыть кто угодно. Но если вам действительно хочется вглянуть на моё резюме (ну вдруг), можете написать в Telegram, и я его с радостью скину. Так что не снижайте за жтот пункт, пожалуйста.",
