const translations = {
    en: {
      ...
      about_me: "About me",
      about_me_text: "I am a bachelor's student in \"Applied Mathematics and Information Science\" at the Faculty of Computer Science at the Higher School of Economics. I am interested in everything that can be described by mathematics. Was an intern at Huawei RRI. I did not want to completely transfer the information from the resume here, since this site can be opened by anyone. But if you really want to take a look at my resume (just in case), you can write to Telegram, and I will gladly send it to you. So don't deduct for this point, please.",
    ...
    ru: {
      ...
      about_me: "Обо мне",
      about_me_text: "Я студент бакалавриата \"Прикладная Математика и Информатика\" факультета компьютерных наук ВШЭ. Интересуюсь всем, что может быть описано математикой. Стажировался в Хуавее. Я не хотел польностью переносить информацию из резюме сюда, так как этот сайт может открыть кто угодно. Но если вам действительно хочется вглянуть на моё резюме (ну вдруг), можете написать в Telegram, и я его с радостью скину. Так что не снижайте за этот пункт, пожалуйста.",
